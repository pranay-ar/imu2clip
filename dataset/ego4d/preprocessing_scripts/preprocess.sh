...
python extract_video.py -v /home/pranayr_umass_edu/imu2clip/ego4d_data/v1/full_scale -o /work/pi_adrozdov_umass_edu/pranayr_umass_edu/checkpoint/pranay/full_videos/processed_video -f 10 -s 224 
