...
# bash run.sh /home/pranayr_umass_edu/imu2clip/configs/train_contrastive/ego4d_imu2video_mw2.yaml
# cd /home/pranayr_umass_edu/meta_project/imu2clip/
# bash download_videos.sh
# bash download_clips.sh

# cd /home/pranayr_umass_edu/imu2clip/dataset/ego4d/preprocessing_scripts
# bash preprocess.sh